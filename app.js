        ...
        window.fetchInitialData = async function() {
            try {
                ...
                console.error(e);
                window.showToast('à¹‚à¸«à¸¥à¸”à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸¥à¹‰à¸¡à¹€à¸«à¸¥à¸§ à¸«à¸£à¸·à¸­à¹ƒà¸Šà¹‰à¸‡à¸²à¸™à¸­à¸­à¸Ÿà¹„à¸¥à¸™à¹Œ', 'warning');
            } finally {
                // Hide loader
        ...
        window.getCurrentLocation = async function(latId, lngId) {
            if (!navigator.geolocation) { window.showToast('à¹€à¸šà¸£à¸²à¸§à¹Œà¹€à¸‹à¸­à¸£à¹Œà¹„à¸¡à¹ˆà¸£à¸­à¸‡à¸£à¸±à¸š GPS', 'error'); return; }
            const latEl = document.getElementById(latId), lngEl = document.getElementById(lngId);
            if(latEl) latEl.value = 'à¸à¸³à¸¥à¸±à¸‡à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸”...'; if(lngEl) lngEl.value = 'à¸à¸³à¸¥à¸±à¸‡à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸”...';
            try {
                const pos = await new Promise((res, rej) => navigator.geolocation.getCurrentPosition(res, rej, { enableHighAccuracy: true, timeout: 10000 }));
                if(latEl) latEl.value = pos.coords.latitude; if(lngEl) lngEl.value = pos.coords.longitude;
                window.showToast('à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸” GPS à¸ªà¸³à¹€à¸£à¹‡à¸ˆ', 'success');
            } catch(e) {
                if(latEl) latEl.value = ''; if(lngEl) lngEl.value = '';
                window.showToast('à¹„à¸¡à¹ˆà¸ªà¸²à¸¡à¸²à¸£à¸–à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸”à¹„à¸”à¹‰', 'error');
            }
        };
        ...
        window.fetchLocationCoordinates = async function(locationName, latId, lngId) {
            ...
            const latEl = document.getElementById(latId), lngEl = document.getElementById(lngId);
            if (latEl && !latEl.value) latEl.value = 'à¸„à¹‰à¸™à¸«à¸²à¸žà¸´à¸à¸±à¸”...';
            if (lngEl && !lngEl.value) lngEl.value = 'à¸„à¹‰à¸™à¸«à¸²à¸žà¸´à¸à¸±à¸”...';
            ...
            if (latLngMatch) {
                setCoords(latLngMatch[1], latLngMatch[2], 'à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸”à¸ˆà¸²à¸à¸¥à¸´à¸‡à¸à¹Œ Google Maps à¸ªà¸³à¹€à¸£à¹‡à¸ˆ');
                return;
            }
            ...
            if (rawCoordsMatch) {
                setCoords(rawCoordsMatch[1], rawCoordsMatch[2], 'à¸£à¸°à¸šà¸¸à¸žà¸´à¸à¸±à¸”à¹‚à¸”à¸¢à¸•à¸£à¸‡à¸ªà¸³à¹€à¸£à¹‡à¸ˆ');
                return;
            }

            // CRRU Custom Locations (High Accuracy Mapping)
            const crruMap = {
                'à¸„à¸“à¸°à¹€à¸—à¸„à¹‚à¸™à¹‚à¸¥à¸¢à¸µà¸”à¸´à¸ˆà¸´à¸—à¸±à¸¥': { lat: '19.985583', lon: '99.844398' },
                'à¸•à¸¶à¸à¸„à¸­à¸¡': { lat: '19.985583', lon: '99.844398' },
                'à¸­à¸²à¸„à¸²à¸£à¸ªà¸³à¸™à¸±à¸à¸‡à¸²à¸™à¸­à¸˜à¸´à¸à¸²à¸£à¸šà¸”à¸µ': { lat: '19.984694', lon: '99.848894' },
                'à¸«à¸­à¸›à¸£à¸°à¸Šà¸¸à¸¡': { lat: '19.985392', lon: '99.847526' },
                'à¸«à¸­à¸›à¸£à¸±à¸Šà¸à¸²': { lat: '19.984364', lon: '99.848262' },
                'à¸­à¸²à¸„à¸²à¸£à¸¢à¸´à¸¡à¹€à¸™à¹€à¸‹à¸µà¸¢à¸¡': { lat: '19.989119', lon: '99.851170' },
                'à¸ªà¸™à¸²à¸¡à¸à¸µà¸¬à¸²à¸à¸¥à¸²à¸‡': { lat: '19.990319', lon: '99.849300' }
            };

            for (const [key, val] of Object.entries(crruMap)) {
                if (locationName.includes(key)) {
                    setCoords(val.lat, val.lon, `à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸” ${key} à¸ªà¸³à¹€à¸£à¹‡à¸ˆ`);
                    return;
                }
            }
            ...
            try {
                ...
                let res = await fetch(`https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(locationName + ' à¸¡à¸«à¸²à¸§à¸´à¸—à¸¢à¸²à¸¥à¸±à¸¢à¸£à¸²à¸Šà¸ à¸±à¸à¹€à¸Šà¸µà¸¢à¸‡à¸£à¸²à¸¢')}&format=json&limit=1`);
                let data = await res.json();
                if (data && data.length > 0) {
                    setCoords(data[0].lat, data[0].lon, 'à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸”à¸ˆà¸²à¸à¸ªà¸–à¸²à¸™à¸—à¸µà¹ˆà¸ªà¸³à¹€à¸£à¹‡à¸ˆ');
                    return;
                }
                
                // Fallback: CRRU default coordinates
                setCoords('19.9846947', '99.8488944', 'à¹ƒà¸Šà¹‰à¸žà¸´à¸à¸±à¸”à¸à¸¥à¸²à¸‡ à¸¡à¸£.à¸Šà¸£. (à¹„à¸¡à¹ˆà¸¡à¸µà¹ƒà¸™à¸à¸²à¸™à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹à¸œà¸™à¸—à¸µà¹ˆà¸ªà¸²à¸˜à¸²à¸£à¸“à¸°)');
            } catch (e) {
                setCoords('19.9846947', '99.8488944', 'à¹ƒà¸Šà¹‰à¸žà¸´à¸à¸±à¸”à¸à¸¥à¸²à¸‡ à¸¡à¸£.à¸Šà¸£. (à¸„à¹‰à¸™à¸«à¸²à¸¥à¹‰à¸¡à¹€à¸«à¸¥à¸§)');
            }
        };
        ...
        window.getCurrentAdminLocation = function(latId, lngId) {
            if (navigator.geolocation) {
                ...
                btn.innerHTML = '<i class="ph-bold ph-spinner animate-spin"></i> à¸£à¸­à¸ªà¸±à¸à¸„à¸£à¸¹à¹ˆ...';
                btn.disabled = true;
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    window.showToast('à¹„à¸¡à¹ˆà¸ªà¸²à¸¡à¸²à¸£à¸–à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸”à¹„à¸”à¹‰ (à¹‚à¸›à¸£à¸”à¸­à¸™à¸¸à¸à¸²à¸• GPS)', 'error');
                    btn.innerHTML = txt; btn.disabled = false;
                }, { enableHighAccuracy: true });
            } else {
                window.showToast('à¹€à¸šà¸£à¸²à¸§à¹Œà¹€à¸‹à¸­à¸£à¹Œà¹„à¸¡à¹ˆà¸£à¸­à¸‡à¸£à¸±à¸š GPS', 'error');
            }
        };
        ...
        window.handleRegistrationSubmit = async function(e, evId) {
            ...
            if (evO) {
                if (evO.lat && evO.lng) {
                    if (!navigator.geolocation) {
                        window.showToast('à¹€à¸šà¸£à¸²à¸§à¹Œà¹€à¸‹à¸­à¸£à¹Œà¹„à¸¡à¹ˆà¸£à¸­à¸‡à¸£à¸±à¸š GPS à¹„à¸¡à¹ˆà¸ªà¸²à¸¡à¸²à¸£à¸–à¹€à¸Šà¹‡à¸„à¸Šà¸·à¹ˆà¸­à¹„à¸”à¹‰', 'error');
                        return;
                    }
                    try {
                        ...
                        if (dist > 150) { 
                            if (err) { err.innerHTML = 'ðŸ“µ à¸­à¸¢à¸¹à¹ˆà¸™à¸­à¸à¸žà¸·à¹‰à¸™à¸—à¸µà¹ˆà¹ƒà¸«à¹‰à¸šà¸£à¸´à¸à¸²à¸£...à¹à¸•à¹ˆà¸¢à¸±à¸‡à¸­à¸¢à¸¹à¹ˆà¹ƒà¸™à¹ƒà¸ˆà¹€à¸˜à¸­'; err.classList.remove('hidden'); }
                            window.showToast('ðŸ“µ à¸­à¸¢à¸¹à¹ˆà¸™à¸­à¸à¸žà¸·à¹‰à¸™à¸—à¸µà¹ˆà¹ƒà¸«à¹‰à¸šà¸£à¸´à¸à¸²à¸£...à¹à¸•à¹ˆà¸¢à¸±à¸‡à¸­à¸¢à¸¹à¹ˆà¹ƒà¸™à¹ƒà¸ˆà¹€à¸˜à¸­', 'error');
                ...
                if (evO.openTime) {
                    ...
                    if (now < openT) { 
                        if (err) { err.innerHTML = 'à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸–à¸¶à¸‡à¹€à¸§à¸¥à¸²à¹€à¸›à¸´à¸”à¹ƒà¸«à¹‰à¹€à¸Šà¹‡à¸„à¸Šà¸·à¹ˆà¸­à¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¸™à¸µà¹‰'; err.classList.remove('hidden'); }
                        window.showToast('à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸–à¸¶à¸‡à¹€à¸§à¸¥à¸²à¹€à¸›à¸´à¸”à¹ƒà¸«à¹‰à¹€à¸Šà¹‡à¸„à¸Šà¸·à¹ˆà¸­', 'error'); return; 
                    }
                }
                if (evO.closeTime) {
                    const closeT = new Date(evO.closeTime);
                    if (now > closeT) { 
                        if (err) { err.innerHTML = 'à¸«à¸¡à¸”à¹€à¸§à¸¥à¸²à¹€à¸Šà¹‡à¸„à¸Šà¸·à¹ˆà¸­à¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¸™à¸µà¹‰à¹à¸¥à¹‰à¸§'; err.classList.remove('hidden'); }
                        window.showToast('à¸«à¸¡à¸”à¹€à¸§à¸¥à¸²à¹€à¸Šà¹‡à¸„à¸Šà¸·à¹ˆà¸­à¹à¸¥à¹‰à¸§', 'error'); return; 
                    }
                }
            }
        ...
        window.submitSurvey = async function(e) {
            ...
            if (isDup) {
                ...
                if (err) { err.innerHTML = 'à¸£à¸°à¸šà¸šà¸•à¸£à¸§à¸ˆà¸žà¸šà¸§à¹ˆà¸²à¸„à¸¸à¸“à¸—à¸³à¹ à¸šà¸šà¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸ªà¸³à¸«à¸£à¸±à¸­à¸ à¸´à¸ˆà¸ à¸£à¸£à¸¡à¸™à¸µà¹‰à¹„à¸›à¹ à¸¥à¹‰à¸§!'; err.classList.remove('hidden'); }
                window.showToast('à¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸‹à¹‰à¸³!', 'warning');
                return;
            }
        ...
        window.renderHistory = function(c) {
            ...
            if (isS) {
                ...
                let badge = { icon: 'ðŸ¥‰', name: 'à¸žà¸¥à¸—à¸«à¸²à¸£', color: 'from-amber-600 to-amber-800', text: 'text-amber-800' };
                if (pts >= 100) badge = { icon: 'ðŸ¥‡', name: 'à¸™à¸²à¸¢à¸£à¹‰à¸­à¸¢', color: 'from-yellow-400 to-orange-500', text: 'text-yellow-700' };
                else if (pts >= 50) badge = { icon: 'ðŸ¥ˆ', name: 'à¸™à¸²à¸¢à¸ªà¸´à¸š', color: 'from-slate-300 to-slate-500', text: 'text-slate-700' };
                    ...
                    <div class="glass rounded-[32px] overflow-hidden border border-white/60 shadow-lg relative bg-white/40">
                        ...
                        <div class="p-8 sm:p-10 flex flex-col md:flex-row items-center gap-8 relative z-10">
                            ...
                            <div class="flex-1 text-center md:text-left">
                                <p class="text-sm font-bold text-slate-500 mb-1 uppercase tracking-widest">à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸™à¸±à¸ à¸¨à¸¶à¸ à¸©à¸²</p>
                                ...
                                <p class="text-slate-600 font-medium">à¸„à¸¸à¸“à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡à¸ à¸´à¸ˆà¸ à¸£à¸£à¸¡à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸” <b class="text-primary text-2xl mx-1">${hD.length}</b> à¸„à¸£à¸±à¹‰à¸‡ à¸£à¸§à¸¡à¹€à¸›à¹‡à¸™ <b class="text-primary text-2xl mx-1">${pts}</b> à¹ à¸•à¹‰à¸¡</p>
                            </div>
                        </div>
                        <div class="px-8 pb-8 sm:px-10 sm:pb-10 relative z-10">
                            <div class="flex justify-between items-center text-sm font-bold text-slate-500 mb-2">
                                <span class="flex items-center gap-2"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/133.gif" class="w-7 h-7 object-contain" alt="eevee">à¸„à¸§à¸²à¸¡à¸„à¸·à¸šà¸«à¸™à¹‰à¸²à¸ªà¸¹à¹ˆà¸£à¸°à¸”à¸±à¸šà¸–à¸±à¸”à¹„à¸›</span>
                                <span>${pts >= 100 ? 'à¸£à¸°à¸”à¸±à¸šà¸ªà¸¹à¸‡à¸ªà¸¸à¸”' : pts + ' / ' + (pts >= 50 ? 100 : 50)}</span>
                            </div>
                ...
                h += `<div class="fade-in"><h2 class="text-xl font-bold mb-5 flex items-center gap-2"><i class="ph-fill ph-list-dashes text-primary"></i> à¸›à¸£à¸°à¸§à¸±à¸•à¸´à¸ à¸²à¸£à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡à¸ à¸´à¸ˆà¸ à¸£à¸£à¸¡</h2><div class="glass rounded-[24px] overflow-hidden border border-white/50"><table class="w-full text-left border-collapse"><thead class="bg-white/50 text-slate-500 text-xs uppercase border-b border-white"><th class="p-5 w-1/2">à¸Šà¸·à¹ˆà¸­à¸ à¸´à¸ˆà¸ à¸£à¸£à¸¡</th><th class="p-5 text-center">à¸§à¸±à¸™à¸—à¸µà¹ˆà¸ˆà¸±à¸”</th><th class="p-5 text-center">à¸ªà¸–à¸²à¸™à¸° / à¹ à¸•à¹‰à¸¡</th></thead><tbody class="text-sm bg-white/60">`;
                if (hD.length > 0) { hD.forEach(x => { h += `<tr class="border-b border-white/50"><td class="p-5 font-bold">${x.eventName}</td><td class="p-5 text-center text-slate-600">${x.date}</td><td class="p-5 text-center"><span class="bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-full text-xs font-bold border border-emerald-100 inline-flex items-center gap-1.5"><i class="ph-fill ph-check-circle"></i> à¸œà¹ˆà¸²à¸™ <span class="bg-emerald-200/50 text-emerald-800 px-1.5 rounded-md ml-1">+10 à¹ à¸•à¹‰à¸¡</span></span></td></tr>`; }); } else { h += `<tr><td colspan="3" class="p-12 text-center text-slate-500 font-medium"><div class="flex flex-col items-center justify-center"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/25.gif" class="w-16 h-16 object-contain mb-3 drop-shadow-sm"><span>à¹„à¸¡à¹ˆà¸žà¸šà¸›à¸£à¸°à¸§à¸±à¸•à¸´</span></div></td></tr>`; }
                ...
                if (cD.length > 0) {
                    ...
                    h += `<div class="glass rounded-[32px] border border-white shadow-sm py-12 text-center"><div class="flex flex-col items-center justify-center"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/25.gif" class="w-16 h-16 object-contain mb-3 drop-shadow-sm"></div><p class="text-slate-600 font-black text-lg">à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µà¹ƒà¸šà¸›à¸£à¸°à¸ à¸²à¸¨à¸™à¸µà¸¢à¸šà¸±à¸•à¸£à¸—à¸µà¹ˆà¸”à¸²à¸§à¸™à¹Œà¹‚à¸«à¸¥à¸”à¹„à¸”à¹‰</p><p class="text-sm font-medium text-slate-500 mt-2">à¸•à¹‰à¸­à¸‡à¸œà¹ˆà¸²à¸™à¸ à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸ à¸´à¸ˆà¸ à¸£à¸£à¸¡à¸—à¸µà¹ˆà¹€à¸›à¸´à¸”à¸£à¸±à¸šà¹ƒà¸šà¸›à¸£à¸°à¸ à¸²à¸¨</p></div>`;
                }
                h += `</div>`;
            }
            h += `</div>`; c.innerHTML = h;
        ...
        window.renderCertificates = function(c) {
            ...
            if (isS) {
                ...
                if (cD.length > 0) { 
                    ...
                    h += `<div class="col-span-full py-16 text-center glass rounded-[32px] border border-white shadow-sm"><div class="flex flex-col items-center justify-center"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/25.gif" class="w-20 h-20 object-contain mb-3 drop-shadow-sm"></div><p class="text-slate-600 font-black text-xl">à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µà¹ƒà¸šà¸›à¸£à¸°à¸ à¸²à¸¨à¸™à¸µà¸¢à¸šà¸±à¸•à¸£</p><p class="text-sm font-medium text-slate-500 mt-2">à¸ à¸£à¸¸à¸“à¸²à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡à¸ à¸´à¸ˆà¸ à¸£à¸£à¸¡à¹ à¸¥à¸°à¸—à¸³à¹ à¸šà¸šà¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¹ƒà¸«à¹‰à¹€à¸ªà¸£à¹‡à¸ˆà¸ªà¸´à¹‰à¸™à¸ à¹ˆà¸­à¸™à¸™à¸°à¸„à¸£à¸±à¸š</p></div>`; 
                }
                h += `</div></div>`;
            }
            h += `</div>`; c.innerHTML = h;
        ...
        window.exportEventCertificates = async function(eId) {
            window.showToast('กำลังรวบรวมรายชื่อผู้ผ่านประเมิน...', 'warning');
            const event = appCache.activities.find(x => String(x.id) === String(eId));
            if (!event) return window.showToast('ไม่พบกิจกรรม', 'error');
            ...
            if (studentEvals.length === 0) return window.showToast('ยังไม่มีผู้ผ่านการประเมิน', 'warning');
        ...
        window.renderAdminCertOverview = async function(c) {
            ...
            if (pageItems.length === 0) { h += `<tr><td colspan="6" class="p-12 text-center text-slate-500 font-medium"><div class="flex flex-col items-center justify-center"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/25.gif" class="w-16 h-16 object-contain mb-3 drop-shadow-sm"><span>à¹„à¸¡à¹ˆà¸žà¸šà¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¸—à¸µà¹ˆà¸„à¹‰à¸™à¸«à¸²</span></div></td></tr>`; } else {
        ...
        window.renderAdminCertificates = async function(c, eId) {
            ...
            if (validStudents.length === 0) { h += `<tr><td colspan="4" class="p-12 text-center text-slate-500 font-medium"><i class="ph-fill ph-certificate text-5xl text-slate-300 mb-3 block mx-auto"></i>à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µà¸œà¸¹à¹‰à¸œà¹ˆà¸²à¸™à¸à¸²à¸£à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸œà¸¥à¸ªà¸³à¸«à¸£à¸±à¸šà¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¸™à¸µà¹‰</span></div></td></tr>`; } else {
        ...
        window.fetchStudentForOrder = async function() {
            ...
            if (existingOrder) { 
                feedback.innerHTML = 'à¸£à¸°à¸šà¸šà¸•à¸£à¸§à¸ˆà¸žà¸šà¸§à¹ˆà¸²à¸„à¸¸à¸“à¸ªà¸±à¹ˆà¸‡à¸ˆà¸­à¸‡à¹€à¸ªà¸·à¹‰à¸­à¹„à¸›à¹à¸¥à¹‰à¸§!'; 
                feedback.classList.remove('hidden'); 
                window.showToast('à¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸à¸²à¸£à¸ªà¸±à¹ˆà¸‡à¸ˆà¸­à¸‡à¸‹à¹‰à¸³!', 'warning'); 
                return; 
            }
        ...
        window.mockOrderSubmit = async function(e) { 
            ...
            if (appCache.orders.find(o => { const s = String(o.studentId).trim(); return s !== '' && s === studentId; })) {
                window.showToast('à¸„à¸¸à¸“à¹„à¸”à¹‰à¸—à¸³à¸à¸²à¸£à¸ªà¸±à¹ˆà¸‡à¸ˆà¸­à¸‡à¹„à¸›à¹à¸¥à¹‰à¸§ à¹„à¸¡à¹ˆà¸ªà¸²à¸¡à¸²à¸£à¸–à¸ªà¸±à¹ˆà¸‡à¸ˆà¸­à¸‡à¸‹à¹‰à¸³à¹„à¸”à¹‰', 'warning');
        ...
        window.submitPayment = async function(e) {
            if(e) e.preventDefault(); if(!isShirtShopOpen) { window.showToast('à¸›à¸´à¸”à¸£à¸±à¸šà¸ˆà¸­à¸‡à¹à¸¥à¹‰à¸§', 'error'); return window.navigate('shirt'); }
        ...
        window.fetchTrackingData = async function() {
            ...
            try {
                // à¹ƒà¸Šà¹‰à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸ˆà¸²à¸ appCache à¸—à¸±à¸™à¸—à¸µ
                let tS = sId;
                let mO = appCache.orders.find(o => String(o.studentId).trim() === tS || String(o.citizenId).trim() === tS);
                
                // à¸–à¹‰à¸²à¸„à¹‰à¸™à¸ˆà¸²à¸à¸­à¸­à¹€à¸”à¸­à¸£à¹Œà¹„à¸¡à¹ˆà¹€à¸ˆà¸­ à¸¥à¸­à¸‡à¹€à¸­à¸²à¹„à¸›à¹€à¸—à¸µà¸¢à¸šà¸à¸±à¸šà¸›à¸£à¸°à¸§à¸±à¸•à¸´à¹€à¸Šà¹‡à¸„à¸­à¸´à¸™à¹€à¸œà¸·à¹ˆà¸­à¸žà¸´à¸¡à¸žà¹Œà¸šà¸±à¸•à¸£à¸›à¸£à¸°à¸Šà¸²à¸Šà¸™à¸¡à¸²
                if (!mO && sId.length >= 10) { 
                ...
                if (mO) { 
                    window.showToast('à¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥', 'success'); 
                    document.getElementById('btn-clear-tracking').classList.remove('hidden'); 
                    window.renderTrackingReceipt(rS, mO); 
                    rS.classList.remove('hidden'); 
                } else { 
                    f.innerHTML = 'à¹„à¸¡à¹ˆà¸žà¸šà¸›à¸£à¸°à¸§à¸±à¸•à¸´à¸à¸²à¸£à¸ªà¸±à¹ˆà¸‡à¸ˆà¸­à¸‡'; 
                    f.classList.remove('hidden'); 
                }
            } catch (error) { 
                f.innerHTML = 'à¸£à¸°à¸šà¸šà¸­à¸­à¸Ÿà¹„à¸¥à¸™à¹Œ'; 
                f.classList.remove('hidden'); 
            } finally { 
                b.innerHTML = txt; b.disabled = false; 
            }
                            ...
                            <div class="bg-gradient-to-br from-red-50/80 to-white border border-red-100 shadow-sm rounded-3xl p-5 md:p-6 mt-4 relative overflow-hidden group/loc">
                                ...
                                <div class="relative z-10">
                                    <div class="flex items-center justify-between mb-5">
                                        <h3 class="text-sm font-black text-red-800 flex items-center gap-3"><div class="w-10 h-10 rounded-2xl bg-red-100 flex items-center justify-center text-red-600 shadow-sm"><i class="ph-fill ph-map-pin-line text-xl"></i></div> à¸žà¸´à¸à¸±à¸”à¸ªà¸–à¸²à¸™à¸—à¸µà¹ˆ (GPS)</h3>
                                        <button type="button" onclick="getCurrentLocation('new-event-lat', 'new-event-lng')" class="hidden md:flex px-5 py-2.5 bg-red-600 text-white font-bold text-xs rounded-xl hover:bg-red-700 transition-colors shadow-md items-center gap-2 hover-lift"><i class="ph-bold ph-crosshair text-sm animate-pulse"></i> à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸”à¸ˆà¸¸à¸”à¸™à¸µà¹‰</button>
                                    </div>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="relative">
                                            <label class="block text-[10px] font-bold text-red-600/70 uppercase mb-1.5 ml-1 tracking-wider">Latitude (à¸¥à¸°à¸•à¸´à¸ˆà¸¹à¸”)</label>
                                            <div class="flex items-center bg-white rounded-2xl border border-red-100 shadow-inner overflow-hidden focus-within:border-red-400 focus-within:ring-4 focus-within:ring-red-100 transition-all">
                                                ...
                                                <input type="text" id="new-event-lat" placeholder="à¹€à¸Šà¹ˆà¸™ 19.967812" class="w-full py-3 pr-4 bg-transparent text-sm font-bold outline-none text-slate-700">
                                            </div>
                                        </div>
                                        <div class="relative">
                                            <label class="block text-[10px] font-bold text-red-600/70 uppercase mb-1.5 ml-1 tracking-wider">Longitude (à¸¥à¸­à¸‡à¸ˆà¸´à¸ˆà¸¹à¸”)</label>
                                            <div class="flex items-center bg-white rounded-2xl border border-red-100 shadow-inner overflow-hidden focus-within:border-red-400 focus-within:ring-4 focus-within:ring-red-100 transition-all">
                                                <div class="pl-4 pr-2 text-red-300"><i class="ph-fill ph-caret-down"></i></div>
                                                <input type="text" id="new-event-lng" placeholder="à¹€à¸Šà¹ˆà¸™ 99.851934" class="w-full py-3 pr-4 bg-transparent text-sm font-bold outline-none text-slate-700">
                                            </div>
                                        </div>
                                    </div>
                                    <button type="button" onclick="getCurrentLocation('new-event-lat', 'new-event-lng')" class="md:hidden mt-5 w-full px-4 py-3.5 bg-red-600 text-white font-bold rounded-2xl hover:bg-red-700 transition-colors shadow-lg flex items-center justify-center gap-2 active:scale-[0.98]"><i class="ph-bold ph-crosshair text-lg"></i> à¸”à¸¶à¸‡à¸žà¸´à¸à¸±à¸”à¸›à¸±à¸ˆà¸ˆà¸¸à¸šà¸±à¸™</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    window.showQRCode = function(id) {
        ...
        modal.innerHTML = 
            '<div class="bg-white rounded-3xl p-8 max-w-sm w-full text-center relative border-4 border-primary shadow-2xl">' +
                ...
                '<h3 class="text-xl font-bold mb-2 text-slate-800">QR Code à¸ªà¸³à¸«à¸£à¸±à¸šà¹€à¸Šà¹‡à¸„à¸Šà¸·à¹ˆà¸­</h3>' +
                ...
                '</div>' +
                '<p class="text-xs font-bold text-slate-400">à¹ƒà¸«à¹‰à¸™à¸±à¸à¸¨à¸¶à¸à¸©à¸²à¸ªà¹à¸à¸™à¸”à¹‰à¸§à¸¢à¸à¸¥à¹‰à¸­à¸‡à¸¡à¸·à¸­à¸–à¸·à¸­<br>à¹€à¸žà¸·à¹ˆà¸­à¹€à¸‚à¹‰à¸²à¸ªà¸¹à¹ˆà¸«à¸™à¹‰à¸²à¹€à¸Šà¹‡à¸„à¸Šà¸·à¹ˆà¸­à¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¸™à¸µà¹‰à¹‚à¸”à¸¢à¸­à¸±à¸•à¹‚à¸™à¸¡à¸±à¸•à¸´</p>' +
                '<button onclick="window.open(\'' + qrUrl + '\', \'_blank\')" class="mt-4 px-4 py-2 bg-primary/10 text-primary font-bold rounded-xl text-xs hover:bg-primary/20 transition">à¹€à¸›à¸´à¸”à¸£à¸¹à¸›à¸ à¸²à¸žà¹€à¸•à¹‡à¸¡</button>' +
            '</div>';
    ...
    window.renderAdminDashboard = async function(c, sF = false) {
        ...
        h += `              </tbody>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6 mb-10">
                <div class="glass p-6 rounded-[32px] border border-white shadow-sm">
                    <h3 class="font-black text-lg mb-6 flex items-center gap-2"><i class="ph-fill ph-student text-primary"></i> à¸ˆà¸³à¸™à¸§à¸™à¸œà¸¹à¹‰à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡à¹à¸•à¹ˆà¸¥à¸°à¸„à¸“à¸°</h3>
                    <div class="relative h-64 w-full"><canvas id="facultyChart"></canvas></div>
                </div>
                <div class="glass p-6 rounded-[32px] border border-white shadow-sm">
                    <h3 class="font-black text-lg mb-6 flex items-center gap-2"><i class="ph-fill ph-t-shirt text-indigo-500"></i> à¸ªà¸±à¸”à¸ªà¹ˆà¸§à¸™à¸¢à¸­à¸”à¸ˆà¸­à¸‡à¹€à¸ªà¸·à¹‰à¸­ (à¹„à¸‹à¸ªà¹Œ)</h3>
        ...
        setTimeout(() => { 
            ...
            cI.forEach(row => {
                if(row && row.length > 6) {
                    const fac = String(row[5] || 'à¹„à¸¡à¹ˆà¸£à¸°à¸šà¸¸').trim();
            ...
            if (ctxFac && facLabels.length > 0) {
                ...
                window.myFacultyChart = new Chart(ctxFac.getContext('2d'), {
                    ...
                    data: {
                        labels: facLabels,
                        datasets: [{ label: 'à¸ˆà¸³à¸™à¸§à¸™à¸œà¸¹à¹‰à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡', data: facData, backgroundColor: gradientFac, borderRadius: 8, maxBarThickness: 50, borderSkipped: false }]
                    },
                    options: { 
                        responsive: true, 
                        maintainAspectRatio: false, 
